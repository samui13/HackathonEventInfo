angular.
    ...
    controller('recentEvent',
		   ...
		   $scope.url = "https://www.google.com/calendar/feeds/cqg671evaqmgmd8ctuih1nme2k%40group.calendar.google.com/private-6c05f1f7fd3dd4ede9802a3a524bf1a5/basic?alt=json&max-results=4&orderby=lastmodified";
		   $http.get($scope.url).success(function(data) {
		       $scope.newEntry = data.feed.entry;
		   });
	       }]).
    controller('recentStartEvent',
	      ['$scope','$http',function($scope,$http){
		   $scope.getID = function(url){
		       var id = url.split("/").pop();
		       return id;
		   };		   
		   $scope.url = "https://www.google.com/calendar/feeds/cqg671evaqmgmd8ctuih1nme2k%40group.calendar.google.com/private-6c05f1f7fd3dd4ede9802a3a524bf1a5/basic?alt=json&max-results=4&orderby=starttime&sortorder=ascending&futureevents=true";
		   $http.get($scope.url).success(function(data) {
		       $scope.newEntry = data.feed.entry;
		   });
		  //
